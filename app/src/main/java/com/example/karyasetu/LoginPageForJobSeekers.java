...
public class LoginPageForJobSeekers extends AppCompatActivity {

    private Button googleSignInButton, backBtn_login_job;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_page_for_job_seekers);
        ...
        backBtn_login_job = findViewById(R.id.back_button_loginpage_job);
        googleSignInButton = findViewById(R.id.google_login_button_job);

        backBtn_login_job.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LoginPageForJobSeekers.this, IndexPage.class);
        ...
        // Enable Firestore Offline Caching for Faster Access
                ...
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    ...
                    if (!queryDocumentSnapshots.isEmpty()) {
                        ...
                        if ("job_seeker".equals(role)) {
                            ...
                            Intent intent = new Intent(LoginPageForJobSeekers.this, HomeScreenForJobSeekers.class);
                            startActivity(intent);
